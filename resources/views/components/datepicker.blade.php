                ...
                <div class="flex flex-wrap -mx-1">
                    <template x-for="monthNum in 12" :key="monthNum">
                        <div style="width: 25%" class=" mb-1">
                            ...
                            'text-gray-600 dark:text-gray-100 hover:bg-primary-200 hover:dark:bg-dark-500': isThisMonth(monthNum) == false && isSelectedMonth(monthNum) == false,
                            'bg-primary-600 dark:bg-dark-900 text-white hover:bg-opacity-75': isSelectedMonth(monthNum) == true }">
                            </div>
                        </div>
                    </template>
                </div>
